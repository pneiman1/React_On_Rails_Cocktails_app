...
mule = Drink.create(
  title: "Moscow Mule aka The Trump",
  description: "A Moscow mule is a cocktail made with vodka, spicy ginger beer, and lime juice, garnished with a slice or wedge of lime. It is a type of buck and therefore sometimes known as a vodka buck. The Moscow mule is usually served in a copper mug.",
...
russian = Drink.create(
  title: "White Russian aka The Putin",
  description: "A White Russian is a cocktail made with vodka, coffee liqueur, and cream served with ice in an Old Fashioned glass. Often milk will be used as an alternative to cream.",
